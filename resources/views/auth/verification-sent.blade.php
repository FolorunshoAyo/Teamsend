    ...
    <div class="block md:grid md:grid-cols-2 md:gap-6">
      <section class="p-6 flex-col min-h-screen bg-green-600 hidden md:flex lg:flex xl:flex">
        ...
        <div class="my-auto">
          ...
          >
            <span class="font-bold text-lg">Verification Mail Sent!!</span><br />
            Please check your email inbox or spam to retrieve your email verification password
          </div>
        </div>
      </section>
      <section class="section flex h-screen items-center justify-center">
        <div class="w-full mx-4 md:w-3/4 md:mx-0 bg-white rounded shadow-lg">
          ...
          <div class="p-4 text-center">
            ...
            <p class="text-2xl md:text-4xl my-4 md:my-0 font-bold text-green-600">Verification Mail Sent!!</p>
            <p class="my-4"> Please check your email inbox or spam to retrieve your email verification password.</p>
          </div>
        </div>
      </section>
    </div>
