    ...
    <div class="p-4 bg-white shadow-sm rounded-sm">
        <ol
            ...
            <li class="{{$currentStep == 1? 'active' : ''}} flex items-center text-green-600 space-x-2.5 rtl:space-x-reverse">
                ...
                <span>
                    <h3 class="font-medium leading-tight">New Group</h3>
                    <p class="text-sm">Enter Basic Group Info</p>
                </span>
            </li>
        ...
        <div id="new-group-form"
            ...
            <div class="step {{$currentStep == 1? 'active' : ''}}">
                <livewire:groups.new-group-step1 :formData="$formData['step1'] ?? []" />
            </div>

            <!-- Step 2 -->
            <div class="step {{$currentStep == 2? 'active' : ''}}">
                <livewire:groups.new-group-step2 :orgId="$orgId"/>
            </div>
