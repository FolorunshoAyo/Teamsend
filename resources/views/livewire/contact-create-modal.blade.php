<div id="new-contact-modal" class="modal active">
    <div class="modal-background --jb-modal-close" wire:click="closeModal"></div>
    <form class="modal-card" wire:submit.prevent="createContact">
      ...
      <section class="modal-card-body">
        ...
        <div class="control mb-2">
            <div class="select">
                <select wire:model.blur="country_code">
                    <option value="">
                    Select Country Code
                    </option>
        ...
        <div class="control">
            <input class="input" type="number" wire:model.blur="phone" placeholder="xxx-xxx" />
        </div>
