<div id="edit-contact-modal" class="modal active">
    <div class="modal-background" wire:click="closeModal"></div>
    <form wire:submit.prevent="updateContact" class="modal-card">
        ...
        <section class="modal-card-body">
            <div class="field spaced">
                ...
                <div class="control icons-left">
                    <input class="input" type="text" wire:model.blur="first_name" value="+{{ $first_name }}"
                        placeholder="Ex. John Doe" />
                    <span class="icon is-small left"><i class="mdi mdi-account"></i></span>
                </div>
                <p class="help">Please enter contact's first name</p>
                @error('first_name')
            ...
            <div class="field spaced">
                ...
                <div class="control icons-left">
                    <input class="input" type="text" wire:model.blur="last_name" value="+{{ $last_name }}"
                        placeholder="Ex. John Doe" />
                    <span class="icon is-small left"><i class="mdi mdi-account"></i></span>
                </div>
                <p class="help">Please enter contact's last name</p>
                @error('last_name')
                    <div class="text-xs text-red-500 mt-2">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="field spaced">
                ...
                <div class="control icons-left">
                    <input class="input" type="email" wire:model.blur="email" value="{{ $email }}"
                        placeholder="Ex: jhondoe@mail.com" />
                    <span class="icon is-small left"><i class="mdi mdi-email-outline"></i></span>
                </div>
                <p class="help">Please enter contact's email address</p>
                @error('email')
                    <div class="text-xs text-red-500 mt-2">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="field spaced">
                <label class="label">User Phone <span class="text-red-600">*</span></label>
                <div class="control mb-2">
                    <div class="select">
                        <select wire:model.blur="country_code" value="{{ $country_code }}">
                            <option value="">
                                Select Country Code
                            </option>
                            ...
                            <option data-countrycode="DO" value="+1-809, 1-829, 1-849">
                            ...
                            <option data-countrycode="PR" value="+1-787, 1-939">
                ...
                <div class="control">
                    <input class="input" value="{{ $phone }}" wire:model.blur="phone" type="text"
                        placeholder="xxx-xxx" />
                </div>
                <p class="help">Please enter contact's phone</p>
                @error('phone')
                    <div class="text-xs text-red-500 mt-2">{{ $message }}</div>
                @enderror
            </div>
